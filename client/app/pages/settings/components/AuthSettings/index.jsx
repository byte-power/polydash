...
import MicrosoftLoginSettings from "./MicrosoftLoginSettings";
...
export default function AuthSettings(props) {
  ...
  const handleChange = useCallback(
    changes => {
      ...
      const allAuthMethodsDisabled =
        !clientConfig.googleLoginEnabled && !clientConfig.microsoftLoginEnabled && !clientConfig.ldapLoginEnabled && !allSettings.auth_saml_enabled;
  ...
  return (
    <DynamicComponent name="OrganizationSettings.AuthSettings" {...props}>
      ...
      <MicrosoftLoginSettings {...props} onChange={handleChange} />
