...
@option(
    ...
    is_flag=True,
    default=False,
    help="user uses Microsoft Auth to login",
)
@option(
    "--password",
    "password",
    default=None,
    help="Password for users who don't use Google/Microsoft Auth " "(leave blank for prompt).",
)
@option(
    "--groups",
    "groups",
...
@option(
    ...
    "password",
    default=None,
    help="Password for root user who don't use Google/Microsoft Auth "
    "(leave blank for prompt).",
)
def create_root(email, name, google_auth=False, microsoft_auth=False, password=None, organization="default"):
    """
    Create root user.
    """
    print(
